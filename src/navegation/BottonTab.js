...
import PokemonBuscadorAxios from '../screens/PokemonBuscadorAxios';
import PokemonBuscadorFetch from '../screens/PokemonBuscadorFetch';
...
export default function BottomTab() {
  return (
    ...
    />
        <Tab.Screen
      name="BuscadorAxios"
      component={PokemonBuscadorAxios}
      options={{
        title: 'Buscador Axios',
        tabBarActiveTintColor: '#3b4cca',
        headerStyle: {
          backgroundColor: '#3b4cca',
        },
    ...
    />
        <Tab.Screen
      name="BuscadorFetch"
      component={PokemonBuscadorFetch}
      options={{
        title: 'Buscador Fetch',
        tabBarActiveTintColor: '#3b4cca',
        headerStyle: {
          backgroundColor: '#3b4cca',
        },
